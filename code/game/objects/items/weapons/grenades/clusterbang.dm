...
//Clusterbang
////////////////////
/obj/item/weapon/grenade/clusterbang
...
/obj/item/weapon/grenade/clusterbang/prime()
	update_mob()
	...
	for(var/loop = again ,loop > 0, loop--)
		new /obj/item/weapon/grenade/clusterbang/segment(loc, payload)//Creates 'segments' that launches a few more payloads
...
//Clusterbang segment
//////////////////////
/obj/item/weapon/grenade/clusterbang/segment
	desc = "A smaller segment of a clusterbang. Better run."
	name = "clusterbang segment"
	icon = 'icons/obj/grenade.dmi'
	icon_state = "clusterbang_segment"

/obj/item/weapon/grenade/clusterbang/segment/New(var/loc, var/payload_type = /obj/item/weapon/grenade/flashbang/cluster)
	..()
...
/obj/item/weapon/grenade/clusterbang/segment/prime()
