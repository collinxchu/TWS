...
/obj/machinery/sleeper
	...
	var/available_chemicals = list("inaprovaline" = "Inaprovaline", "stoxin" = "Soporific", "paracetamol" = "Paracetamol", "antitoxin" = "Dylovene", "dexalin" = "Dexalin")
