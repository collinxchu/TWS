...
/obj/item/mecha_parts/mecha_equipment/tool/drill/diamonddrill
	...
	construction_cost = list("metal"=10000,MAT_DIAMOND=6500)
	equip_cooldown = 20
	force = 15
...
/obj/item/mecha_parts/mecha_equipment/tool/rcd
	...
	construction_cost = list("metal"=30000,MAT_PLASMA=25000,MAT_SILVER=20000,MAT_GOLD=20000)
			...
			if(0)
				if (istype(target, /turf/simulated/wall))
					...
					if(do_after_cooldown(target))
						if(disabled) return
						chassis.spark_system.start()
						target:ChangeTurf(/turf/simulated/floor/holofloor/desert) //for now, no space-drilling
						playsound(target, 'sound/items/Deconstruct.ogg', 50, 1)
						chassis.use_power(energy_drain)
...
/obj/item/mecha_parts/mecha_equipment/anticcw_armor_booster //what is that noise? A BAWWW from TK mutants.
	...
	energy_drain = 50
	range = 0
	construction_cost = list("metal"=20000,MAT_SILVER=5000)
...
/obj/item/mecha_parts/mecha_equipment/antiproj_armor_booster
	...
	energy_drain = 50
	range = 0
	construction_cost = list("metal"=20000,MAT_GOLD=5000)
	var/deflect_coeff = 1.15
	var/damage_coeff = 0.8
...
/obj/item/mecha_parts/mecha_equipment/repair_droid
	...
	energy_drain = 100
	range = 0
	construction_cost = list("metal"=10000,MAT_GOLD=1000,MAT_SILVER=2000,"glass"=5000)
	var/health_boost = 2
...
/obj/item/mecha_parts/mecha_equipment/tesla_energy_relay
	...
	energy_drain = 0
	range = 0
	construction_cost = list("metal"=10000,MAT_GOLD=2000,MAT_SILVER=3000,"glass"=2000)
...
/obj/item/mecha_parts/mecha_equipment/generator
	...
	energy_drain = 0
	range = MELEE
	construction_cost = list("metal"=10000,MAT_SILVER=500,"glass"=1000)
