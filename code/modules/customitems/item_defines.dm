...
/obj/item/weapon/reagent_containers/pill/fluff/xanax
	name = "xanax pill"
	desc = "Used to deal with anxiety."
	icon_state = "pill9"
	New()
		..()
...
/obj/item/weapon/reagent_containers/pill/fluff/ecstasy
	name = "ecstasy pill"
	desc = "A wonderful pill intended to stimulate the senses."
	icon_state = "pill8"
	New()
		..()
...
/obj/item/weapon/reagent_containers/pill/fluff/poppers
	name = "popper"
	desc = "For simulating the sensual side of you."
	icon_state = "pill8"
	New()
		..()
		reagents.add_reagent("coffee", 5)
