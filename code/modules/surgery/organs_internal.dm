...
/datum/surgery_step/internal/remove_embryo
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class='danger'>[user] rips the larva out of [target]'s ribcage!</span>",
...
/datum/surgery_step/internal/fix_organ
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		user.visible_message("<span class='danger'>[user]'s hand slips, getting mess and tearing the inside of [target]'s [affected.name] with \the [tool]!</span>", \
		"<span class='danger'>Your hand slips, getting mess and tearing the inside of [target]'s [affected.name] with \the [tool]!</span>")
		var/dam_amt = 2
...
/datum/surgery_step/internal/fix_organ_robotic //For artificial organs
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		user.visible_message("<span class='danger'>[user]'s hand slips, gumming up the mechanisms inside of [target]'s [affected.name] with \the [tool]!</span>", \
		"<span class='danger'>Your hand slips, gumming up the mechanisms inside of [target]'s [affected.name] with \the [tool]!</span>")
...
/datum/surgery_step/internal/remove_organ
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message("<span class='danger'>[user]'s hand slips, damaging the flesh in [target]'s [affected.name] with \the [tool]!</span>", \
		"<span class='danger'>Your hand slips, damaging the flesh in [target]'s [affected.name] with \the [tool]!</span>")
...
/datum/surgery_step/internal/replace_organ
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class='danger'>[user]'s hand slips, damaging \the [tool]!</span>", \
		"<span class='danger'>Your hand slips, damaging \the [tool]!</span>")
