...
/datum/language/sign
	name = "Sign Language"
	desc = "A type of language that is used by communicating with hands and expressions."
	speech_verb = "signs"
	whisper_verb = "signs discreetly"
	exclaim_verb = "signs passionately"
	colour = "solcom"
	key = "8"
	flags = NO_TALK_MSG | NO_STUTTER
