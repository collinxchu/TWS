...
/datum/design/intercom_electronics
	...
	category = list("initial", "Electronics") #TOREMOVE */
...
/datum/design/health_sensor
	...
	category = list("initial", "Medical") #TOREMOVE */
...
/datum/design/canvas/twentythreeXtwentythree
	...
	category = list("initial", "Miscellaneous") #TOREMOVE */
...
/datum/design/newscaster_frame
	...
	category = list("initial", "Construction") #TOREMOVE */
...
/datum/design/c38
	...
	category = list("initial", "Security")#TOREMOVE */
...
/datum/design/buckshot_shell
	...
	category = list("hacked", "Security") #TOREMOVE */
