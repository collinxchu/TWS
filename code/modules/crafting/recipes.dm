...
/datum/table_recipe/pin_removal
	...
	tools = list(/obj/item/weapon/pickaxe/plasmacutter, /obj/item/weapon/screwdriver, /obj/item/weapon/wirecutters)
	time = 100
	category = CAT_WEAPON
...
/datum/table_recipe/ed209
	name = "ED209"
	result = /obj/machinery/bot/secbot/ed209
...
/* #TOREMOVE /datum/table_recipe/improvisedslugoverload
