...
/obj/item/weapon/reagent_containers/food/snacks/soup/tomato
	...
	bonus_reagents = list("nutriment" = 1, "tomatojuice" = 10)
...
/obj/item/weapon/reagent_containers/food/snacks/soup/mystery/New()
	..()
	extra_reagent = pick("capsaicin", "frostoil", "tricordrazine", "banana", "blood", "slimejelly", "toxin", "banana", "carbon", "imidazoline")
...
/obj/item/weapon/reagent_containers/food/snacks/soup/amanitajelly
	...
	bitesize = 3
	bonus_reagents = list("nutriment" = 1, "vitamin" = 5)
	list_reagents = list("nutriment" = 6, "psilocybin" = 3, "amatoxin" = 6)
...
/obj/item/weapon/reagent_containers/food/snacks/soup/stew
	...
	list_reagents = list("nutriment" = 10, "imidazoline" = 5, "tomatojuice" = 5, "vitamin" = 5)
	bitesize = 10
	volume = 100
