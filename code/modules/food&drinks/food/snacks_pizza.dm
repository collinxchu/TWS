...
/obj/item/weapon/reagent_containers/food/snacks/pizza
	...
	icon = 'icons/obj/food/pizza&spaghetti.dmi'
	w_class = 3
	slices_num = 6
	volume = 80
...
/obj/item/weapon/reagent_containers/food/snacks/pizza/donkpocket
	...
	bonus_reagents = list("nutriment" = 5, "vitamin" = 5)
	list_reagents = list("nutriment" = 25, "tomatojuice" = 6, "tricordrizine" = 10, "vitamin" = 5)
...
/obj/item/pizzabox/update_icon()
	...
	if(open)
		...
		if(pizza)
			var/image/pizzaimg = image('icons/obj/food/pizza&spaghetti.dmi', icon_state = pizza.icon_state)
			pizzaimg.pixel_y = -3
			overlays += pizzaimg
