...
/obj/machinery/cooker/proc/burnfood(mob/user, obj/item/weapon/reagent_containers/props)
	...
	var/datum/effect/effect/system/smoke_spread/bad/smoke = new /datum/effect/effect/system/smoke_spread/bad()    // burning things makes smoke!
